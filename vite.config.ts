...
const pwaPlugin = VitePWA({
  ...
  injectRegister: "auto",
  // In dev mode, enable the service worker so the manifest is served
  devOptions: {
    enabled: true,
    type: "module",
  },
  manifest: {
    name: "RE CRM",
    short_name: "RE CRM",
    description: "Commercial Real Estate Investment CRM",
    theme_color: "#1e1a15",
  ...
  workbox: {
    ...
    // Raise the precache size limit — the main bundle is ~3.4 MB
